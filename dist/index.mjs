...
<body>
    ...
    <div id="howToPlay">
        <h2>\u{1F40D} Snake Rounds</h2>
        <div class="instructions">
            <div class="instruction-item"><span class="instruction-icon icon-coconut">\u{1F965}</span> Brown = Grow (normal)</div>
            <div class="instruction-item"><span class="instruction-icon icon-speed">\u26A1</span> Green = Speed boost</div>
            <div class="instruction-item"><span class="instruction-icon icon-ultra">\u{1F48E}</span> Blue = EXTREME speed</div>
            <div class="instruction-item"><span class="instruction-icon icon-ice">\u2744\uFE0F</span> Ice = Slow down</div>
            <div class="instruction-item"><span class="instruction-icon icon-coin">\u{1F4B0}</span> Coins = 50 for extra life</div>
